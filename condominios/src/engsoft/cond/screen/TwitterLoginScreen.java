...
public class TwitterLoginScreen extends Screen {
    /**
     *
     */
    private static final long serialVersionUID = 1L;

    public TwitterLoginScreen() {
        ...
        cod.addKeyListener(new KeyListener() {
			...
			public void keyReleased(KeyEvent arg0) {
				if (arg0.getKeyCode() == KeyEvent.VK_ENTER) {
	                LoginManager.getInstance().doTwitterLogin(cod.getText());
				}
        ...
        JButton ttLogin = new JButton("Finalizar login");
        ttLogin.addActionListener(new ActionListener() {
        ...
        ttLogin.setAlignmentX(CENTER_ALIGNMENT);
